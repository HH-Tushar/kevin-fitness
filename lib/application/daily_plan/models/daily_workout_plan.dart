...
class DailyWorkoutPlanDetails {
  ...
  DailyWorkoutPlanDetails({required this.workouts, required this.status});

  factory DailyWorkoutPlanDetails.fromRawJson(String str) =>
      DailyWorkoutPlanDetails.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DailyWorkoutPlanDetails.fromJson(Map<String, dynamic> json) =>
      DailyWorkoutPlanDetails(
        workouts: List<WorkoutElement>.from(
